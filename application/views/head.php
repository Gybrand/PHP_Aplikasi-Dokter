...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/logo/idi.png">
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/bootstrap-filestyle-1.2.1/src/bootstrap-filestyle.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/fancybox/jquery.easing-1.3.pack.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/fancybox/jquery.fancybox-1.3.4.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/fancybox/jquery.mousewheel-3.0.4.pack.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/easyautocomplete/jquery.easy-autocomplete.min.js">
    ">
  </script>

  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/select2.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/select2.min.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/select2.full.js">
    ">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/select2.full.min.js">
    ">
  </script>

  <script type="text/javascript" src="<?php echo base_url(); ?>assets/plugin/dataTables/datatables.min.js">
    ">
  </script>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <img src="<?php echo base_url(); ?>assets/img/logo/idi.png" class=" media-object" style="width:45px;" alt="" />
      </div>
